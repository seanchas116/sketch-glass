...
class FillShader extends Shader {
  ...
  setViewportTransform(transform: Float32Array) {
    this.gl.uniformMatrix3fv(this.uViewportTransform, false, transform);
  }

  setSceneTransform(transform: Float32Array) {
    this.gl.uniformMatrix3fv(this.uSceneTransform, false, transform);
  }
}
